...
import 'package:flutter_clean_architecture_tdd/infra/http/http.dart';
...
void main() {
  ...
  group('POST', () {
    ...
    test('Should throws ServerError if post throws', () async {
      mockError();
      final future = sut.request(url: url, method: 'post');
      expect(future, throwsA(HttpError.serverError));
    });
  ...
  group('GET', () {
    ...
    test('Should return BadRequestError if get returns 400 without body',
        () async {
      mockResponse(400, body: '');
    ...
    test('Should throws ServerError if get throws', () async {
      mockError();
      final future = sut.request(url: url, method: 'get');
      expect(future, throwsA(HttpError.serverError));
    });
